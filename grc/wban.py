...
class wban(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.ieee802_15_4_frame_buffer_cc_0 = ieee802_15_4.frame_buffer_cc(1)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.ieee802_15_4_oqpsk_phy_0, 'rxout'), (self.qtgui_time_sink_x_0, 'in'))
        self.connect((self.ieee802_15_4_frame_buffer_cc_0, 0), (self.ieee802_15_4_oqpsk_phy_0, 0))
        self.connect((self.ieee802_15_4_oqpsk_phy_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.ieee802_15_4_frame_buffer_cc_0, 0))
