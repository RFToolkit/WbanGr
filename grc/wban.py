...
class wban(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "wban")
        ...
        self.freq = freq = 2360000000 + 1000000*(channel - 11)
        self.symb0 = symb0 = 2
        self.symb = symb = 2
    ...
    def set_channel(self, channel):
        ...
        self._channel_callback(self.channel)
        self.set_freq(2360000000 + 1000000*(self.channel - 11))
...
def main(top_block_cls=wban, options=None):
