...
class ieee802154_transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.top_grid_layout.addWidget(self._channel_tool_bar, 1, 0, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.blocks_stream_to_tagged_stream_0 = blocks.stream_to_tagged_stream(gr.sizeof_float, 1, 32, "packet_len")
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_float*1, '/opt/gr-wban/p.bin', True)
        ...
        self.connect((self.digital_clock_recovery_mm_xx_0, 0), (self.blocks_file_sink_1, 0))
        self.connect((self.digital_clock_recovery_mm_xx_0, 0), (self.blocks_stream_to_tagged_stream_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.analog_quadrature_demod_cf_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.blocks_throttle_0, 0))
        self.connect((self.osmosdr_source_0, 0), (self.qtgui_time_sink_x_0_0, 0))
